...
import com.ustc.community.dao.LoginTicketMapper;
import com.ustc.community.dao.MessageMapper;
...
public class MaperTest {
    ...
    public void testSelectLoginTicket(){
        LoginTicket loginTicket = loginTicketMapper.selectByTicket("nba");
        System.out.println(loginTicket);

        loginTicketMapper.updateStatus("nba", 1);
        loginTicket = loginTicketMapper.selectByTicket("nba");
        System.out.println(loginTicket);
    }
